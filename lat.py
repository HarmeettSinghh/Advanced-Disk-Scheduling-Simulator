...
# # #     ax.set_ylim(-1, len(seek_sequence))
# # #     ax.set_title(f"{algorithm_name} Disk Scheduling Visualization", fontsize=14, fontweight='bold', color='orangered')
# # #     ax.set_xlabel("Cylinder Number", fontsize=12, color='orangered')
# # #     ax.set_ylabel("Request Order", fontsize=12, color='orangered')
...
# # #     style.configure("TLabel", background="black", foreground="orangered")
# # #     style.configure("TButton", background="orangered", foreground="black")
# # #     style.configure("TEntry", fieldbackground="black", foreground="orangered")
...
# request_label = ttk.Label(frame, text="Disk Requests (comma-separated):", font=("Arial", 12))
# request_label.grid(row=0, column=0)
# request_input = ttk.Entry(frame, font=("Arial", 12))
# request_input.grid(row=0, column=1)

# head_label = ttk.Label(frame, text="Initial Head Position:", font=("Arial", 12))
# head_label.grid(row=1, column=0)
# head_start_input = ttk.Entry(frame, font=("Arial", 12))
# head_start_input.grid(row=1, column=1)

# algo_label = ttk.Label(frame, text="Algorithm:", font=("Arial", 12))
# algo_label.grid(row=2, column=0)
# algo_options = ["FCFS", "SSTF", "SCAN", "C-SCAN"]
# selected_algo = tk.StringVar(root)
# selected_algo.set("FCFS")
# algo_dropdown = ttk.Combobox(frame, textvariable=selected_algo, values=algo_options, state="readonly", font=("Arial", 12))
# algo_dropdown.grid(row=2, column=1)

# run_button = ttk.Button(frame, text="Run Simulation", command=run_simulation, style='Run.TButton')
